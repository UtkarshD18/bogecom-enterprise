...
public class CartItem extends BaseEntity {
    ...
    // to enforce strict modular isolation (Cart module shouldn't require Product module's entities directly)
    // In a monolithic architecture this could be a direct relation, but storing IDs makes extraction easier.
